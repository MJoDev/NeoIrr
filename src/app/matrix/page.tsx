        ...
        <div className="flex flex-col h-screen justify-between"> 
            ...
            <div className="ml-2 mx-2 grid grid-cols-2"> 
                {!isNextClicked ? (
                    ...
                    <button onClick={handleReadAndSaveClick} className="rounded-full border border-blue-500 flex justify-center items-center mb-10 text-2xl gap-1 py-4 px-4 hover:scale-105 transition mx-5 ml-5">
                        REC
                    </button>
                )}
                <BackButton/>
